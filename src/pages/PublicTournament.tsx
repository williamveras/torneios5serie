...
export default function PublicTournament() {
  ...
  // Show the draw tab whenever there is any fase with matchups generated by the system,
  // including Fase de Grupos (transparency of the draw). Agenda continues in "Confrontos".
